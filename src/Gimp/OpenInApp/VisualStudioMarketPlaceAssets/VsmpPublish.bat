...
VsixPublisher.exe publish -payload "D:\_git\OpenInApp\Src\Gimp\OpenInApp\bin\Debug\OpenInGimp.vsix" -publishManifest "D:\_git\OpenInApp\Src\Gimp\OpenInApp\VisualStudioMarketPlaceAssets\VsmpPublish.json" -personalAccessToken "vsmp_pat"
