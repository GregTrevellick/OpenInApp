...
VsixPublisher.exe publish -payload "D:\_git\OpenInApp\Src\Gimp\OpenInApp\bin\Debug\OpenInApp.vsix" -publishManifest "D:\_git\OpenInApp\VsmpPublish.json" -personalAccessToken "vsmp_pat"
