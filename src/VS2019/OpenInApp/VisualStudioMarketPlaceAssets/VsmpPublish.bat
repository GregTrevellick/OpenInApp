...
VsixPublisher.exe publish -payload "D:\_git\OpenInApp\Src\VS2019\OpenInApp\bin\Debug\OpenInVS2019.vsix" -publishManifest "D:\_git\OpenInApp\Src\VS2019\OpenInApp\VisualStudioMarketPlaceAssets\VsmpPublish.json" -personalAccessToken "vsmp_pat"
