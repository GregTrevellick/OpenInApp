...
VsixPublisher.exe publish -payload "D:\_git\OpenInApp\Src\AndroidStudio\OpenInApp\bin\Debug\OpenInAndroidStudio.vsix" -publishManifest "D:\_git\OpenInApp\Src\AndroidStudio\VsmpPublish.json" -personalAccessToken "vsmp_pat"
