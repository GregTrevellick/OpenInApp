...
VsixPublisher.exe publish -payload "D:\_git\OpenInApp\Src\PaintDotNet\OpenInApp\bin\Debug\OpenInApp.vsix" -publishManifest "D:\_git\OpenInApp\Src\PaintDotNet\VsmpPublish.json" -personalAccessToken "vsmp_pat"
