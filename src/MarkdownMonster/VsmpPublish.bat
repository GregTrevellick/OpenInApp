...
VsixPublisher.exe publish -payload "D:\_git\OpenInApp\Src\MarkdownMonster\OpenInApp\bin\Debug\OpenInMarkdownMonster.vsix" -publishManifest "D:\_git\OpenInApp\Src\MarkdownMonster\VsmpPublish.json" -personalAccessToken "vsmp_pat"
